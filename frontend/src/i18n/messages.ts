...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'statistics.scopeHint':
      'Most numbers below use current filters. Streak uses all attempts.',
    'statistics.sessions': 'Study attempts',
    ...
    'statistics.avgQuizHint': 'Quiz attempts in selected range',
    'statistics.streak': 'Current streak',
    'statistics.streakHint': 'Calculated from all attempts',
    ...
    'statistics.emptyQuizSeries': 'No quiz attempts yet for selected filters.',
    'statistics.emptyQuizSeriesHint':
      'Complete at least one quiz attempt to unlock this chart.',
    'statistics.moduleSnapshotTitle': 'Module activity snapshot',
    'statistics.moduleSnapshotHint':
      'Attempts and best quiz result per module for current filters.',
    ...
    'statistics.noWeakSessions':
      'Great job. No weak quiz attempts found for current filters.',
    'statistics.startQuiz': 'Start quiz',
    'statistics.sessionHistory': 'Attempt history',
    'statistics.moduleLabel': 'Module:',
    'statistics.noSessionsForFilter': 'No attempts found for this filter.',
    'statistics.loadingSessions': 'Loading attempts...',
    ...
    'statistics.loadMore': 'Load more',
    'statistics.loadingMore': 'Loading more...',
    ...
    'admin.sessionsToday': 'Attempts today',
    ...
    'admin.totalSessions': 'Total attempts',
    'admin.owner': 'Owner',
    ...
    'admin.deleteModuleQuestion': 'Delete module?',
    'admin.deleteModuleDescription':
      'This permanently removes "{title}" and all related data.',
    ...
    'auth.cardLearnedSubtitle': 'Productive attempt',
    ...
    'aria.sessionStatistics': 'Attempt statistics',
    ...
    'edit.common.zeroSessions': '0 attempts completed',
    ...
    'editQuiz.importTextVariantsInvalid':
      'Question #{index}: acceptedVariants must be an array of strings.',
    ...
    'quizStudy.leaveTitle': 'Leave quiz attempt?',
    'quizStudy.leaveDescription':
      'Your current progress in this quiz is not submitted yet. If you leave, the attempt timer stops and your answers may be lost. Are you sure you want to leave?',
    'quizStudy.leaveAction': 'Leave attempt',
    'quizStudy.stayAction': 'Stay here',
    'quizStudy.resultsTitle': '{title} - Quiz results',
    'quizStudy.resultsCorrect': '{correct} of {total} correct',
    'quizStudy.sessionComplete': 'Attempt complete',
    ...
    'flashStudy.noCardsToStart':
      'Add at least one flashcard to start an attempt.',
    'flashStudy.study': 'Study',
    'flashStudy.cardProgress': 'Card {current}/{total}',
    'flashStudy.resultsTitle': '{title} - Flashcards results',
    'flashStudy.sessionComplete': 'Attempt complete',
    'flashStudy.savingSession': 'Saving attempt…',
    'flashStudy.saveFailed': 'Could not save attempt: {error}',
    ...
    'flashStudy.timerRemainingAria': 'Time remaining in this attempt',
    'flashStudy.leaveTitle': 'Leave study attempt?',
    'flashStudy.leaveDescription':
      'Your current progress in this attempt is not saved yet. If you leave, the attempt timer stops and your card marks may be lost. Are you sure you want to leave?',
    'flashStudy.leaveAction': 'Leave attempt',
    ...
    'sessionTimer.timeUpToast': "Time's up — finishing the attempt.",
  ...
  ru: {
    ...
    'statistics.scopeHint':
      'Большинство метрик ниже учитывают фильтры. Стрик считается по всем прохождениям.',
    'statistics.sessions': 'Учебные прохождения',
    'statistics.sessionsHint': 'С учётом выбранного диапазона/модуля',
    'statistics.cardsStudied': 'Изучено карточек',
    'statistics.cardsHint': 'Карточки из flashcard-прохождений',
    'statistics.avgQuizScore': 'Средний балл тестов',
    'statistics.avgQuizHint': 'Quiz-прохождения в выбранном диапазоне',
    'statistics.streak': 'Текущий стрик',
    'statistics.streakHint': 'Считается по всем прохождениям',
    ...
    'statistics.emptyQuizSeries':
      'Нет quiz-прохождений для выбранных фильтров.',
    'statistics.emptyQuizSeriesHint':
      'Пройдите хотя бы одно quiz-прохождение, чтобы увидеть график.',
    'statistics.moduleSnapshotTitle': 'Активность по модулям',
    'statistics.moduleSnapshotHint':
      'Прохождения и лучший результат теста по модулям в текущих фильтрах.',
    'statistics.noModuleActivity':
    ...
    'statistics.noWeakSessions':
      'Отлично! Слабых quiz-прохождений не найдено для текущих фильтров.',
    'statistics.startQuiz': 'Начать тест',
    'statistics.sessionHistory': 'История прохождений',
    'statistics.moduleLabel': 'Модуль:',
    'statistics.noSessionsForFilter': 'Нет прохождений для этого фильтра.',
    'statistics.loadingSessions': 'Загружаем прохождения...',
    'statistics.type': 'Тип',
    ...
    'statistics.loadMore': 'Показать еще',
    'statistics.loadingMore': 'Загружаем еще...',
    ...
    'admin.sessionsToday': 'Прохождений сегодня',
    ...
    'admin.totalSessions': 'Всего прохождений',
    ...
    'admin.deleteModule': 'Удалить модуль',
    'admin.deleteModuleQuestion': 'Удалить модуль?',
    'admin.deleteModuleDescription':
      'Это действие навсегда удалит "{title}" и все связанные данные.',
    'admin.moduleDeleted': 'Модуль удален.',
    ...
    'auth.cardLearnedSubtitle': 'Продуктивное прохождение',
    ...
    'aria.sessionStatistics': 'Статистика прохождения',
    ...
    'edit.common.zeroSessions': 'Завершено прохождений: 0',
    ...
    'editQuiz.timer': 'Таймер прохождения',
    ...
    'editQuiz.importTextVariantsInvalid':
      'Вопрос №{index}: acceptedVariants должен быть массивом строк.',
    'editQuiz.importMatchingPairsMin':
    ...
    'editFlash.timer': 'Таймер прохождения',
    ...
    'quizStudy.leaveAction': 'Выйти из прохождения',
    ...
    'quizStudy.sessionComplete': 'Прохождение завершено',
    ...
    'flashStudy.noCardsToStart':
      'Добавьте хотя бы одну карточку, чтобы начать прохождение.',
    ...
    'flashStudy.sessionComplete': 'Прохождение завершено',
    'flashStudy.savingSession': 'Сохраняем прохождение…',
    'flashStudy.saveFailed': 'Не удалось сохранить прохождение: {error}',
    ...
    'flashStudy.timerRemainingAria': 'Оставшееся время прохождения',
    'flashStudy.leaveTitle': 'Выйти из прохождения?',
    'flashStudy.leaveDescription':
      'Текущий прогресс в этом прохождении еще не сохранен. Если выйти, таймер прохождения остановится, а отметки по карточкам могут быть потеряны. Продолжить?',
    'flashStudy.leaveAction': 'Выйти из прохождения',
    ...
    'sessionTimer.timeUpToast': 'Время вышло — завершаем прохождение.',
    'sessionTimer.completedInMinutesSeconds':
