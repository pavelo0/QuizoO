...
Утверждаю
Заведующий кафедрой \***\*\_\_\_\_\*\*** В.В. Смелов
...
1. Срок сдачи студентом законченной работы: «23 мая 2026 г.»
2. Исходные данные к проекту:
   ...
    создание модуля типа «Карточки» иди «Квиз»;
...
4. Форма представления выполненного курсового проект:
   ...
   1 Постановка задачи и обзор аналогичных решений 01.03.2026
   2 Проектирование web-приложения 10.03.2026
   3 Реализация web-приложения 18.03.2026
   4 Тестирование web-приложения 26.04.2026
   5 Оформление пояснительной записки 12.05.2026
   6 Защита проекта 23.05.2026

5. Дата выдачи задания ¬¬¬¬¬¬¬¬¬¬¬¬¬

Руководитель**\*\*\*\***\_\_**\*\*\*\*** В.В. Смелов
(подпись)
